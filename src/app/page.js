            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 dark:text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Build, scale, and grow your business with our comprehensive SaaS platform. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-400 lg:mx-auto">
              Our platform provides all the tools and features you need to build, scale, and grow your business.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Lightning Fast</p>
                <p className="mt-2 ml-16 text-base text-gray-500 dark:text-gray-400">
                  Built with Next.js for optimal performance and speed. Your users will love the fast loading times.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Secure by Default</p>
                <p className="mt-2 ml-16 text-base text-gray-500 dark:text-gray-400">
                  Enterprise-grade security with Supabase authentication and real-time database protection.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900 dark:text-white">Team Collaboration</p>
                <p className="mt-2 ml-16 text-base text-gray-500 dark:text-gray-400">
                  Built for teams with role-based access control and real-time collaboration features.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
              <div className="p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Starter</h3>
              ...
              <div className="px-6 pt-6 pb-8">
                ...
                <ul className="mt-6 space-y-4">
                  <li className="flex space-x-3">
                    ...
                    <span className="text-sm text-gray-500 dark:text-gray-400">Up to 5 team members</span>
                  </li>
                  <li className="flex space-x-3">
                    <Check className="flex-shrink-0 h-5 w-5 text-green-500" />
                  ...
                  <li className="flex space-x-3">
                    <Check className="flex-shrink-0 h-5 w-5 text-green-500" />
                    <span className="text-sm text-gray-500 dark:text-gray-400">Email support</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="border border-blue-500 rounded-lg shadow-sm divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
              <div className="p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Pro</h3>
                <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="px-6 pt-6 pb-8">
                ...
                <ul className="mt-6 space-y-4">
                  ...
                  <li className="flex space-x-3">
                    <Check className="flex-shrink-0 h-5 w-5 text-green-500" />
                    <span className="text-sm text-gray-500 dark:text-gray-400">Custom integrations</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className="bg-blue-600">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-200">
            Join thousands of businesses that trust our platform to grow their business.
          </p>
          <Link
            href="/auth"
